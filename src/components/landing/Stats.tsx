export default function Stats({ title, count, stat }: { title: string, count: string, stat: string }) {
    return (
        <div className="flex flex-col gap-[8px] p-[16px] w-[300px] border-[1px] border-solid border-[#E2E8F0] shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] hover:scale-105 transition-all duration-300">
